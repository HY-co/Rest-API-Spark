package com.hanyang.courses;

import com.google.gson.Gson;
import com.hanyang.courses.dao.CourseDao;
...
import com.hanyang.testing.ApiClient;
import com.hanyang.testing.ApiResponse;
import org.junit.*;
...
public class ApiTest {
    ...
    private final String RUNSCRIPT = ";INIT=RUNSCRIPT from 'classpath:db/init.sql'";
    ...
    public void setUp() throws Exception {
        Sql2o sql2o = new Sql2o(TEST_DATASOURCE + RUNSCRIPT, "", "");
